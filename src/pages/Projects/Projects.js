...
const Projects = () => {
  return (
    <>
      <div className="continer w-10/12 project" id="projects">
        <h2 className="col-12 mt-3 mb-1 text-center text-uppercase">
          TOP RECENT PROJECTS
        </h2>
        <hr />
        <p className="pb-3 text-center">
          Excited to share my latest project – a dynamic web application developed using the MERN stack (MongoDB, Express.js, React, Node.js). It boasts a sleek interface, powered by React for an engaging user experience. The backend, supported by Express.js and Node.js, ensures seamless operations, while MongoDB stores data robustly.
        </p>
        {/* card design */}
